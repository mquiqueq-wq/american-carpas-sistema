...
urlpatterns = [
    ...
    # GANTT HIGHCHARTS
    # ====
    path('<int:proyecto_id>/gantt/', views.proyecto_gantt_highcharts, name='proyecto_gantt'),
    path('<int:proyecto_id>/gantt-data/', views.proyecto_gantt_data_highcharts, name='proyecto_gantt_data'),
