...
class TipoProveedorForm(forms.ModelForm):
    ...
    class Meta:
        model = TipoProveedor
        fields = ['nombre_tipo', 'descripcion', 'activo']
...
class ProveedorForm(forms.ModelForm):
    ...
    gran_contribuyente = forms.BooleanField(
        label='Gran Contribuyente',
        required=False,
        widget=forms.CheckboxInput(attrs={'class': 'form-check-input'})
    )
    
    autorretenedor = forms.BooleanField(
    ...
    class Meta:
        ...
        fields = [
            ...
            'categoria_principal', 'regimen_tributario', 'responsable_iva',
            'gran_contribuyente', 'autorretenedor', 'pais', 'departamento',
            'ciudad', 'direccion', 'codigo_postal', 'telefono_principal',
            'telefono_secundario', 'email_principal', 'email_secundario',
            'sitio_web', 'banco', 'tipo_cuenta', 'numero_cuenta',
            'tiempo_entrega_promedio', 'condiciones_pago', 'monto_minimo_pedido',
            'descuento_pronto_pago', 'calificacion', 'notas_internas',
